...
class Task:
    ...
    def calculate_circle_points(self):
        ...
        self.radius = (
            np.linalg.norm(self.P7.t - self.P8.t) / 2
        )  # Half the distance between any 2 consecutive points of the diamond, say, P7 and P8
        self.P6 = self.center
    ...
    def t3_draw_flag(self):
        r1 = self.traj_control.loop(self.P1, self.P2)
        r2 = self.traj_control.loop(self.P2, self.P3)
        r3 = self.traj_control.loop(self.P3, self.P4)
        r4 = self.traj_control.loop(self.P4, self.P1)
    ...
    def t6_draw_diamond(self):
        r1 = self.traj_control.loop(self.P5, self.P7)
        r2 = self.traj_control.loop(self.P7, self.P8)
        r3 = self.traj_control.loop(self.P8, self.P9)
        r4 = self.traj_control.loop(self.P9, self.P5)
